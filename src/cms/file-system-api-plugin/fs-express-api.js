...
/* Express allows for app object setup */
/* to handle paths (our api routes) */
module.exports = function(app) {
  ...
  app.use('/:path', function(req, res, next) {
    ...
    // otherwise pass the control out of this middleware
    // to the next middleware function in this stack (back to regular)
    else next()
  })
